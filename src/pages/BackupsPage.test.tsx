...
describe("RestoreControl", () => {
  ...
  it("ignores a double-click while a restore is in flight", async () => {
    ...
    // A second click/tap while the first restore request is still in flight
    // must not enqueue a second restore job against the same live stack.
    fireEvent.click(confirmButton);
...
describe("BackupsPage", () => {
  ...
  it("ignores a double-click while a backup trigger is in flight", async () => {
    mockAuth = { token: "tok", role: "admin" };
    ...
    const triggerButton = screen.getByRole("button", { name: "Trigger Backup" });
    fireEvent.click(triggerButton);
    // A second click/tap while the first backup job is still being enqueued
