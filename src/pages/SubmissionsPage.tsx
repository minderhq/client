...
export function SubmissionsPage() {
  ...
  const {
    ...
    (signal) =>
      apiFetch<SubmissionListResponse>("/v1/marketplace/submissions/mine", {
        token,
        signal,
      }),
  ...
  return (
    <>
      ...
      {!isAuthenticated ? (
        <InfoCallout icon="lock">Log in to submit a plugin or see your own submissions.</InfoCallout>
      ) : (
        <>
